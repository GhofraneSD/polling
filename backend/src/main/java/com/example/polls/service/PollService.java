...
public class PollService {
        ...
        /*
         * public PagedResponse<CommentResponse> getPollComments(Long pollId) {
         * 
         * List<Comment> comments = commentRepository.findByPoll(pollId);
         * 
        ...
        public PagedResponse<PollResponse> getPollsByTopic(String topicName, UserPrincipal currentUser, int page,
                        int size) {
                validatePageNumberAndSize(page, size);

                Topic topic = topicRepository.findByName(topicName)
                                .orElseThrow(() -> new ResourceNotFoundException("Topic", "name", topicName));

                // Retrieve all polls by the given topic name
                Pageable pageable = PageRequest.of(page, size, Sort.Direction.DESC, "createdAt");
                Page<Poll> polls = pollRepository.findByTopic(topic.getId(), pageable);
        ...
        public PollResponse castVoteAndGetUpdatedPoll(Long pollId, VoteRequest voteRequest, UserPrincipal currentUser) {
                ...
                if (poll.getExpirationDateTime().isBefore(Instant.now())) {
                        logger.info("Sorry! This Poll has already expired");
